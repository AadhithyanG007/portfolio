...
export const medinexusDetails = `# 🏥 MediNexus - Secure Telemedicine Platform
...
---end of SOON ---  `;
export const infinityPoolsDetails = `# 🧊 Infinity Pools
...
`;
export const soonDetails = `# ⏱️ SOON
...
- **Tailwind CSS** for UI.
`;
export const portfolioDetails = `# 🚀 Portfolio Website
