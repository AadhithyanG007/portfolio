...
export const LampHeader = ({ className }: { className?: string }) => {
  return (
    <div
      className={cn(
        "relative flex h-[40vh] flex-col items-center justify-end overflow-hidden bg-black w-full z-0",
        className,
      )}
    >
      ...
      <motion.h2
        ...
        className="relative z-50 -mt-20 mb-10 bg-gradient-to-br from-white to-neutral-400 bg-clip-text text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        About Me
      </motion.h2>
    </div>
