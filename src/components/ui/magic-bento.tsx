...
const DEFAULT_GLOW_COLOR = "251, 191, 36"; // Amber color
...
const defaultCardData: BentoCardProps[] = [
  ...
  },
  {
    color: "#000000",
    title: "User-Focused",
    description: "Creating intuitive and accessible experiences",
    label: "Design",
  },
];
      ...
      <style>
        {`
          .bento-section {
            ...
            --white: hsl(0, 0%, 100%);
            --amber-primary: rgba(251, 191, 36, 1);
            --amber-glow: rgba(251, 191, 36, 0.2);
            --amber-border: rgba(251, 191, 36, 0.8);
          }
          ...
          {cards.map((card, index) => {
            ...
            if (enableStars) {
              return (
                ...
                >
                  <div className="card__header flex justify-between gap-3 relative text-amber-400">
                    <span className="card__label text-base">{card.label}</span>
                  </div>
                  <div className="card__content flex flex-col relative text-white">
                    <h3
                      className={`card__title font-normal text-base m-0 mb-1 text-amber-100 ${textAutoHide ? "text-clamp-1" : ""}`}
                    >
                      {card.title}
                    </h3>
                    <p
                      className={`card__description text-xs leading-5 text-zinc-400 ${textAutoHide ? "text-clamp-2" : ""}`}
                    >
                      {card.description}
                    </p>
                  </div>
